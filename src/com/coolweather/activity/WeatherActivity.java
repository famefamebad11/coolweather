...
public class WeatherActivity extends Activity implements android.view.View.OnClickListener {
	 ...
	 * 更新天气按钮
	 */
	private Button refereshWeather;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		refereshWeather = (Button) findViewById(R.id.referesh_weather);
		...
		refereshWeather.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.referesh_weather:
			publishText.setText("同步中。。。。。");
			SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
			String weatherCode = prefs.getString("weather_code", "");
			if (!TextUtils.isEmpty(weatherCode)) {
				Log.i("TEST", "!TextUtils.isEmpty(weatherCode)");
				queryWeatherInfo(weatherCode);
			}
			break;
